...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    rowner: `⚠️ Perintah ini hanya dapat digunakan oleh *Owner Bot!*`,
    owner: `⚠️ Perintah ini hanya dapat digunakan oleh *Owner Bot!*`,
    mods: `⚠️Perintah ini hanya dapat digunakan oleh *Owner Bot!*`,
    premium: 'Perintah Ini khusus pengguna _*Premium*_ !',
    group: 'Perintah ini hanya dapat digunakan di grup!',
    private: 'Gunakan Perintah ini di Chat Pribadi bot',
    admin: 'Perintah ini hanya untuk *Admin* grup!',
    nsfw: `Perintah ini hanya bisa diaktifkan oleh @${global.kontak[0].split`@`[0]}`,
    botAdmin: 'Jadikan Bot sebagai admin untuk menggunakan perintah ini',
    unreg: `Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar fahril.20*`
  }[type]
