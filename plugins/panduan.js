...
let handler = async(m, { conn, usedPrefix, args, command }) => {
    ...
    let tulisan = `
Halo ${name}, ${ucapan()} selamat datang di menu panduan fahrilbotz. di menu ini kalian bisa mendapatkan panduan soal bot whatsapp.
┌〔 List Panduan 〕
├ how
├ owner
├ add
...
Query: ${search}
`.trim(), 'Owner', '.owner', 'Menu', '.?', 'Rules', '.rules', m)
}
handler.tags = ['main']
...
global.panduan = [
    ...
    },
    {
        "index": "2",
        "search": "how",
        "deskripsi": "Cara menggunakan bot adalah dengan mengetikkan command bot. List command bot ada pada menu bot. jangan lupa, untuk mengakses command harus menggunakan prefix.\nPrefix fahrilbotz adalah all prefix.\nContoh penggunaan prefix dan command yang benar: *.menu*",
        "judul": "Cara menggunakan bot dan prefix"
    },
    {
        "index": "3",
        "search": "add",
        "deskripsi": "Cara menambahkan bot ke dalam group. silahkan baca pada menu sewa dengan mengetikkan *.sewa*. fahrilbotz memberlakukan trial gratis 3 hari. Setelah 3 hari maka bot akan keluar dari group. ada opsi 1 minggu, 1 bulan dan 2 bulan berlangganan.",
        "judul": "Cara menambahkan bot ke group",
    },
    {
        "index": "4",
        "search": "berlangganan",
        "deskripsi": "Layanan berlangganan fahrilbotz adalah dengan menyewa bot dalam jumlah waktu ke dalam group. Untukm list harga/layanan silahkan baca pada *.sewa*",
        "judul": "Berlangganan"
    },
    {
        "index": "5",
